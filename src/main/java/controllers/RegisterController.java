...
public class RegisterController extends AbstractController {
	...
	public ModelAndView saveAdministrator(
			@Valid AdministratorForm administratorForm, BindingResult binding) {
		ModelAndView result;
			...
			try {
				...
				if (oops.getMessage() == "Passwords are different") {
					result = createEditModelAndViewAdministrator(
							administratorForm, "register.password.error");
	...
	protected ModelAndView createEditModelAndViewAdministrator(
	...
	protected ModelAndView createEditModelAndViewCustomer(
